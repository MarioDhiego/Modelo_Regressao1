...
O script utilizado para gerar o gráfico de dispersão no R sem a observação 69 (**R$ 12.460,00**) é mostrado a seguir:
...
A presença desse aoutlier tem consequências importantes para o resultado da7 regressão.
